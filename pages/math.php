...
<body>
    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="text-center mb-0">Math</h1>
    ...
    <div class="modal fade" id="announcementModal" tabindex="-1" role="dialog" aria-labelledby="announcementModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="announcementModalLabel">Math Announcements</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script>
        ...
        function loadAnnouncements() {
            ...
            fetch('get_announcements.php?subject=math')
                .then(response => response.json())
                .then(data => {
                    if (data.error) {
                        content.html('<div class="alert alert-danger">' + data.error + '</div>');
                    ...
                    // Mark announcements as read when they are displayed
                    data.forEach(announcement => {
